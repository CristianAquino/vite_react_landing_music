    ...
    <div className="musicPlayer flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232a4e] rounded-xl mt-5">
      ...
      <div className="upperPart flex items-center justify-between">
        ...
        <div className="profile flex">
          <img
            src="https://raw.githubusercontent.com/ZainRk/Youtube-Music-App/master/src/img/Mask%20Group%2023.png"
            alt="avatar"
          ...
          <div className="details flex flex-col ml-4">
            ...
            <span className="text-sm text-gray-500">Unknow Artist</span>
          </div>
        </div>
        <div>
          <img
            src="https://raw.githubusercontent.com/ZainRk/Youtube-Music-App/master/src/img/path.png"
            alt="path"
            className="h-[1rem]"
          />
        </div>
      ...
      <div className="lowerPart">
        ...
        <div className="track flex justify-between text-sm text-gray-500 flex-[2]">
          <span>2: 30</span>
          <img
            src="https://raw.githubusercontent.com/ZainRk/Youtube-Music-App/master/src/img/Group%209.png"
            alt="group9"
            className="w-[16rem]"
          />
          <span>4: 30</span>
